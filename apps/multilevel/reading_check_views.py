...
class ReadingTestCheckApiView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary="Reading testini tekshirish",
        operation_description="Reading testi uchun foydalanuvchi javoblarini tekshiradi.",
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Faqat Reading testini tekshirish
        if section.type != 'reading':
            return self.handle_error("Bu endpoint faqat Reading testi uchun!", status.HTTP_400_BAD_REQUEST)
    ...
    def finalize_test(self, user, test_result, responses):
        ...
        if test_result.status == 'completed':
            ...
            if validate_test_level(exam_level):
                score_details = get_score_details('reading', correct_count, total_questions, exam_level)
            ...
            if is_multilevel_exam:
                ...
                return {
                    ...
                    "section_score": score,
                    "message": "Reading section tugatildi. Barcha sectionlar tugagandan keyin umumiy natija ko'rsatiladi."
                }
            else:
